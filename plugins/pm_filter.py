...
async def auto_filter(client, msg, spoll=False):
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"<b>👋 Hᴇʟʟᴏ {messages.from_user.first_name},\n\nThe Movie You Requested is Not Found in Our Database. Make Sure The Spelling of The Movie You Sent is Correct. You Can Get The Movie Only if The Spelling is Correct And it Must be Released in OTT 🫶\n\nTIP : Search The Movie You Want on Google And Copy The Spelling, Then Send it to Group (Don't Use Any Symbols) ☺️</b>",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🔍 Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ", url="www.google.com")],[InlineKeyboardButton("💻 Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ", url="https://t.me/CMG_Adminchatbot")]]))
    ...
    if imdb:
        ...
        cap = f"<b>Hello 👋 {message.from_user.mention}, \n\n🔖 Query : {search} \n\n📍Select Your Desired File From Below \n\n● SERIES ➠ @SERIESGRAM_LINK \n● FILMOGRAPHY ➠ @CMG_FILMOGRAPHY</b>"
